...
int main()
{
	...
	insert(L, "금");														//<월 금 수>
	print(L); 
	printf("책에 있는 함수와 다른 함수를 사용했습니다.");
	printf("티낼려고 일부러 순서 틀리게 했습니다.\n 오류 아닙니다.\n");
	getchar();
	...
	printf("(5) 원하는 자리에 노드 추가하기! \n");
	
	printf("어떤 요일 다음에 추가할까요?: ");
	scanf("%s",&b);
	
	printf("추가하고싶은 요일을 입력하세요: ");
	scanf("%s",&a);
